...
const TIMELINE_EVENTS = [
  ...
  },
  {
    title: "Graduation I",
    date: "2023.05.xx",
    description: "Graduated from my high school where I stayed for 6 years",
    side: "right",
  },
  {
    title: "New Chapter",
    date: "2023.09.06",
    description: "First time leaving family to another country alone for university. on Wisconsin!",
    side: "left",
  },
  {
    title: "Graduation II",
    date: "2026.06.01",
    description: "Graduated one year earlier than expected, full of love for madison, my friends, and mentors. Ready to next journey",
    side: "right",
  },
  {
    title: "University of Washington Seattle",
    date: "2025.02.14",
    description: "Came alone to a new place, start another new chapter. Its gonna be alright",
    side: "left",
  },
];
